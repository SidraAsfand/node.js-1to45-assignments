...
let GuestArr = ["Bilal raza", "Zakki khilji", "Haris Malick"];
let canNotAttend = "Zakki khilji";
let newGuest = "Hadi Islam";
GuestArr[GuestArr.indexOf(canNotAttend)] = newGuest;
GuestArr.unshift("Gulam");
let middleGuest = "Rehman alam";
